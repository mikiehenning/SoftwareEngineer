...
(
    ...
    BJScore INT(11) NOT NULL,
    SusScore INT(11) NOT NULL,
    size DOUBLE(3,2) NOT NULL,
    depth INT(11) NOT NULL,
    edges INT(11) NOT NULL,
    undermining INT(11) NOT NULL,
    necType INT(11) NOT NULL,
    necAmnt INT(11) NOT NULL,
    exType INT(11) NOT NULL,
    exAmnt INT(11) NOT NULL,
    SCSW INT(11) NOT NULL,
    perTisEd INT(11) NOT NULL,
    perTiInd INT(11) NOT NULL,
    granTis INT(11) NOT NULL,
